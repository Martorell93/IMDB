...
export class Movie {
    ...
    public showMovie() {        
        ...
        console.log(`Director: ${this.director?.getName()}`);
        console.log(`Writer: ${this.writer?.getName()}`);
        ...
        console.log(`Producer: ${this.producer?.getName()}`);
        console.log(`Distributor: ${this.distributor?this.distributor:""}`);
        console.log(`Genre: ${this.genre?this.genre:""}`);
